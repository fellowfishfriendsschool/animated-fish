...
<g id="upperArm" transform="translate(289.03584,152.18832)">
  ...
  <g id="lowerArm" transform="translate(46.88037,-0.60884)">
   ...
   <!-- Wrist group at elbow→wrist offset -->
    <g id="hand" transform="translate(15.2209,-35.92132)" stroke-width="3">
      ...
      <path
        d="M10.95905,-12.48114
           ...
           c4.65695,0.68812 7.01818,5.79559 7.01818,12.01623
           z"
        fill="#16ffff"
        stroke-linecap="butt"/>
    </g>
...
<g id="mouth">
 ...
 <script>
  ...
  const centerX = (viewBox.width - viewBox.width * scaleFactor) / 2;
  const centerY = (viewBox.height - viewBox.height * scaleFactor) / 2;
  ...
  const charWidth = viewBox.width * scaleFactor * 0.5;
  const charHeight = viewBox.height * scaleFactor * 0.5;
  ...
  function bounce(axis, direction) {
    ...
    if (axis === "x") {
      props.attr = {
        transform: `translate(${x + bounceDistance * direction},${y}) scale(${facing * scaleFactor},${scaleFactor})`
      };
    } else {
      props.attr = {
        transform: `translate(${x},${y + bounceDistance * direction}) scale(${facing * scaleFactor},${scaleFactor})`
      };
    }

    gsap.to(character, props);
  }
  ...
  window.addEventListener("keydown", (e) => {
    ...
    switch (e.key) {
      case "ArrowUp":
        ...
        break;
      case "ArrowDown":
        if (y + step + charHeight <= viewBox.height) {
          y += step;
          moved = true;
        } else {
          bounce("y", 1);
      ...
      case "ArrowLeft":
        ...
        break;
      case "ArrowRight":
        if (x + step + charWidth <= viewBox.width) {
          x += step;
          facing = -1;
          moved = true;
        } else {
